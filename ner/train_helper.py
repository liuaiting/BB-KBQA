...
def get_args_parser():
    ...
    bert_path = '/data/lat/bert/chinese_L-12_H-768_A-12/'
    root_path = '/data/lat/bert/'

    group1 = parser.add_argument_group('File Paths',
                                       'config the path, checkpoint and filename of a pretrained/fine-tuned BERT model')
    group1.add_argument('-data_dir', type=str, default=os.path.join(root_path, 'data/MD'),
    ...
    group1.add_argument('-output_dir', type=str, default=os.path.join(root_path, 'md_output'),
    ...
    group2.add_argument('-max_seq_length', type=int, default=60,
                        help='The maximum total input sequence length after WordPiece tokenization.')
    group2.add_argument('-do_train', action='store_true', default=True,
                        help='Whether to run training.')
    group2.add_argument('-do_eval', action='store_true', default=True,
                        help='Whether to run eval on the dev set.')
    group2.add_argument('-do_predict', action='store_true', default=True,
    ...
    group2.add_argument('-dropout_rate', type=float, default=0.9,
                        help='Dropout rate')
    group2.add_argument('-clip', type=float, default=5,
                        help='Gradient clip')
