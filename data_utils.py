...
pm_train = "data/PM/train/train.txt"
pm_dev = "data/PM/dev/dev.txt"
pm_test9870_ec = "data/PM/test/candidate_predicate_bert_9870_ec.txt"
pm_infer9870_all = "data/PM/infer/candidate_predicate_bert_9870_all.txt"
        ...
        for line in f:
            ...
            if i % 5 == 1:
                ...
                try:
                    ...
                    print("%d: There is no golden relation in question." % idx)
                    output_line = ""
                ...
                for c in line[1:]:
                    if c != relation:
                        ...
                        print("%d: Golden relation appears in candidate predicates." % idx)
        ...
        for line in f:
            ...
            if i % 4 == 1:
                ...
                try:
                    ...
                    print("%d: There is no golden entity in question." % idx)
                    output_line = ""
                ...
                for c in line[1:]:
                    if c != entity:
                        ...
                        print("%d: Golden entity appears in candidate entities." % idx)
                # outputs:
